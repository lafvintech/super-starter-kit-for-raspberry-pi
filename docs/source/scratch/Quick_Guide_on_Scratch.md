...
When [installing Raspberry Pi Operating System](../preparation/Installing_the_OS(Common).rst), you have to choose the version with desktop, either with desktop only or with desktop and recommended software.
