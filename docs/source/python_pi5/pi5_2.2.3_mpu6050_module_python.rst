...
.. image:: ../python_pi5/img/list/2.2.6_mpu6050_list.png
...
.. image:: ../python_pi5/img/schematic/2.2.6_mpu6050_schematic.png
...
.. image:: ../python_pi5/img/connect/2.2.6.png


**Step 2**: Setup I2C (see Appendix `i2C Setup <../Appendix/i2c_configuration.html>`_. If you have set I2C, skip this
step.)
...
.. note::
    ...
    * If you get the error ``FileNotFoundError: [Errno 2] No such file or directory: '/dev/i2c-1'``, you need to refer to `I2C Config <../Appendix/i2c_configuration.md>`_ to enable the I2C.
